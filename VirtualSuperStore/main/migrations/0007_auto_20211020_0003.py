# Generated by Django 3.2.8 on 2021-10-19 21:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='related_customers', to='main.Order', verbose_name='Заказы покупателя'),
        ),
    ]
